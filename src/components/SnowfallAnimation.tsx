...
export default function SnowfallAnimation() {
  ...
  useEffect(() => {
    ...
    function createParticle(): Particle {
      if (!canvas) {
        ...
        return {
          x: 0, y: 0, vx: 0, vy: 0, size: 2, opacity: 0.5, baseHue, swirlSeed: 0
        };
      }
    ...
    console.log("SnowfallAnimation: creating", particleCount, "particles");
  ...
  if (!isClient) {
    return (
      <div className="relative w-full overflow-hidden h-full">
        <div className="absolute inset-0 bg-gradient-to-b from-slate-50/80 to-slate-200/60 flex items-center justify-center">
          <div className="text-white text-2xl font-bold">Loading Animation...</div>
        </div>
      </div>
    );
  }
  ...
  if (!mounted) {
    console.log("SnowfallAnimation: not mounted, returning null");
    return (
      <div className="relative w-full overflow-hidden h-full">
        <div className="absolute inset-0 bg-gradient-to-b from-slate-50/80 to-slate-200/60 flex items-center justify-center">
  ...
  console.log("SnowfallAnimation: mounted, rendering canvas");
